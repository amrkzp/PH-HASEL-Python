...
#Note: CUDA is not enabled for GPU (add .cuda() to tensors and model)
...
def plot_results(prediction, train_y, test_y, tag):
    ...
    # axs[3].plot(x_for_voltage, test_input_voltage, label='Voltage', linewidth=0.2)
    # axs[3].legend()
    fig.tight_layout()
    fig2.tight_layout()
    # fig.canvas.manager.full_screen_toggle()
    # plt.savefig('./Models/' + tag + '/Results.png')
    plt.show()
